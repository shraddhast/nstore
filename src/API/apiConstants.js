...
export const CATEGORY = `${BASE_URL}api/product?limit=5&page=1&category=6065c425f45ada6429eb42c9`;
...
export const ADD_NEW_ADDRESS = `${BASE_URL}/api/user/address`;
export const NEW_ADDRESS_PUT = `${BASE_URL}/api/user/address/606f061005d6fd68732e528b`;
