            ...
            <Grid container className={classes.grid}>
                <Grid item sm={12} md={4} lg={4}>
                    ...
                    <Typography variant="p" className={classes.content}>
                        Neosoft company is here at your quick and easy services
                        for sharing
                        Contact Information:
                        <br/>
                        Email: neosoft@neosoftmail.com<br/>
                        Phone:99990000<br/>
                        MUMBAI,INDIA
                    </Typography>
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4}>
                    ...
                    <Typography variant="p" className={classes.content}>
                        Sign up to get exclusive offers from our favorite brands and great deals<br/>
                        <TextField className={classes.text}/><br/>
